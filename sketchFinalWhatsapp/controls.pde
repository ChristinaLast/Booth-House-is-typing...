...
void guiSetup() {
  ...
  for(Toggle t:b.getItems()) {
   ...
   titleLabel = cp5.addTextlabel("label2")
                    .setText("Topic Modeling and Word Vector Visualization of Guardian Angels Whatsapp group Conversation")
                    .setPosition(50,30)
                    .setColorValue(255)
                    .setFont(createFont("Lato-Light",30))
                    ;
/*   
